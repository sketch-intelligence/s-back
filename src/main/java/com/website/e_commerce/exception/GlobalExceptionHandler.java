...
//    }
    ...
    public ResponseEntity<ProblemDetail> handelUnauthorizedRoleException(UnauthorizedRoleException exception){
        return createProblemDetailResponse(HttpStatus.UNAUTHORIZED,exception.getMessage(),"user unauthorized");
    }

    @ExceptionHandler(UserAlreadyExistsException.class)
    public ResponseEntity<ProblemDetail> handleUserAlreadyExistsException(UserAlreadyExistsException exception) {
        return createProblemDetailResponse(HttpStatus.CONFLICT, exception.getMessage(), "User already exists");
    }
